...
export function PageWrapper({ title, description, children }: { title: string; description?: string; children: ReactNode }) {
  return (
    <main className="min-h-screen min-w-0 flex-1 bg-[radial-gradient(circle_at_top_left,rgba(37,99,235,0.18),transparent_30rem),radial-gradient(circle_at_top_right,rgba(20,184,166,0.11),transparent_28rem),var(--portal-bg)] px-4 py-6 sm:px-6 lg:px-8">
