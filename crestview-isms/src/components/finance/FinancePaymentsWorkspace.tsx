  ...
  return (
    <div className="reference-workspace space-y-6">
      ...
      <Card id="record-payment">
        <CardHeader><CardTitle>Record a payment</CardTitle><p className="text-sm font-semibold text-[var(--portal-muted)]">Scan the student QR code or enter the CIS/ST/000001 student ID. Duplicate records for the same student and date are protected.</p></CardHeader>
