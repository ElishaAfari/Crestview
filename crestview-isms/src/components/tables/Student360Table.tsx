...
const columns: ColumnDef<Student360Row>[] = [
  {
    accessorKey: "student",
    header: "Student",
    cell: ({ row }) => (
...
export function Student360Table({ data }: { data: Student360Row[] }) {
  return <DataTable data={data} columns={columns} searchPlaceholder="Search student, class, risk, invoice, report..." />;
}
