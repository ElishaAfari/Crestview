...
export function StudentCsvImportForm() {
  const [result, setResult] = useState<{ ok: boolean; message: string; errors?: string[]; credentials?: Array<{ name: string; studentNumber: string; password: string }> } | null>(null);
