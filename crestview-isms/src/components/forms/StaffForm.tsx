  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <Input
          placeholder="Teacher, HR officer, bursar..."
      ...
      <div className="sm:col-span-2">
        ...
        <Select
          ...
          disabled={form.watch("role") !== "teacher"}
        >
      ...
      <div className="sm:col-span-2 flex flex-col items-start gap-3">
        <Button type="submit" disabled={form.formState.isSubmitting}>
          {form.formState.isSubmitting ? "Inviting..." : "Invite staff member"}
        </Button>
        {message ? (
          <p
            className={`text-sm ${submitted ? "text-emerald-300" : "text-red-300"}`}
          >
            {message}
          </p>
        ) : null}
