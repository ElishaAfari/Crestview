    ...
    <Card>
      ...
      <CardContent className="space-y-3">
        {displayEvents.map((event) => (
          <div key={event.title} className="portal-subtle-card flex items-center justify-between gap-4 rounded-lg p-3">
            <span className="text-sm font-black text-[var(--portal-text)]">{event.title}</span>
