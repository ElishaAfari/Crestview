...
const adminGroups: SuiteGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: "Import Students", href: "/students/import" },
  ...
  },
  {
    ...
    links: [
      ...
      { title: "Lesson Note Vetting", href: "/academics-office/lesson-notes" },
  ...
  teacher: [
    ...
    },
    {
      ...
      links: [
        ...
        { title: "Schemes of Work", href: "/teacher/schemes" },
        { title: "Schemes and Notes", href: "/teacher/lesson-notes" },
