...
export const operationsWorkspaces: OperationsWorkspace[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { key: "audit", label: "Audit log", description: "Recent protected data changes across the platform.", table: "audit_logs", fields: [{ key: "action", label: "Action" }, { key: "table_name", label: "Table" }, { key: "record_id", label: "Record" }, { key: "created_at", label: "Created" }], searchFields: ["action", "table_name", "record_id"] },
